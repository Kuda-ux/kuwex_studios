...
const blogPosts: Record<string, BlogPost> = {
  ...
  "every-sector-zimbabwe-needs-digital-transformation": {
    ...
    excerpt: "From the clinic still using paper appointment books to the lodge in Nyanga losing bookings to commission platforms — digital transformation is not a tech-company luxury. It is a survival requirement for every sector, every city, every organisation in Zimbabwe.",
  ...
  "social-media-alone-not-digital-strategy-zimbabwe": {
    ...
    excerpt: "You're posting on Facebook every day. Your WhatsApp status is full of promotions. You have 5,000 Instagram followers. But when someone wants to verify you're legitimate, check your prices at 11pm, or find you on Google — what happens? If your answer is uncomfortable, keep reading.",
  ...
  "ai-rewards-digitally-prepared-businesses-zimbabwe": {
    ...
    excerpt: "AI is quietly changing how customers find, compare, and choose businesses in Zimbabwe. It doesn't knock on doors or run ads. It scans your digital presence and decides whether to recommend you. Here's what it's looking for — and how to make sure your business is in the conversation.",
