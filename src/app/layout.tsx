...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "answer engine optimization Zimbabwe",
    "AEO Zimbabwe",
    "AI readiness audit Zimbabwe",
    "digital agency Africa",
    "best web designers Africa",
    "e-commerce website Zimbabwe",
    "Next.js developers Zimbabwe",
    "React developers Zimbabwe",
    "website cost Zimbabwe",
    "logo design Zimbabwe",
    "PPC management Zimbabwe",
    "local SEO Harare",
    "Google Business Profile Zimbabwe",
    "digital strategy Zimbabwe SMEs",
    "WhatsApp business marketing Zimbabwe",
    "AI integration Zimbabwe business",
    "Zimbabwe National AI Strategy",
    "digital marketing company Africa",
    "web design company Africa",
    ...
    "AI readiness assessment Zimbabwe",
    ...
    "AI readiness score Zimbabwe SME",
    "AI adoption Zimbabwe small business",
    "tourism website design Zimbabwe",
    "real estate website Zimbabwe",
    "mining company website Zimbabwe",
    "agriculture website Zimbabwe",
    "healthcare website Zimbabwe",
    "e-commerce website Zimbabwe",
  ...
  verification: {
    ...
    yandex: 'kuwexstudios',
    other: {
      'msvalidate.01': 'kuwexstudios2026',
    },
  },
  icons: {
    icon: [
